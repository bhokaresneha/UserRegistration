...
public class UserRegistration {
    ...
    public static boolean validFirstName(String fname) throws InvalidUserDataException {
    ...
    public static boolean validLastName(String lastname)throws InvalidUserDataException {
...
*/
    ...
    public static boolean validEmail(String email)throws InvalidUserDataException {
    ...
    public static boolean validMobileNumber(String phoneNo)throws InvalidUserDataException {
